...
<body>
    ...
    <section class="home">
        ...
        <div class="inicio">
            ...
            <div class="text">
                ...
                <div class="info">
                    <h5>Stock</h1>
                        <h6>Administrar Stock</h2>
                </div>

                <div class="agregar">
                    <a href="agregar_stock.php">Añadir Stock</a>
                </div>
            ...
            <div class="contenedor-resultados" style="display:flex;justify-content:center;">

                <table class="tabla-resultados" style="width:60%">
                    <thead>
                        <tr>
                            <th>Stock Actual</th>
                            <th>Producto</th>
    ...
    document.querySelector('.contenedor-busqueda [type="reset"]').addEventListener('click', function() {
        ...
        document.querySelector('.btnReset').classList.remove(
            'btnReset-show'); // Ocultar el icono de limpieza
    ...
    function nextPage() {
        ...
        if (paginaActual >= parseInt(document.getElementById("totalPages").textContent)) {
            document.getElementById("btnNext").style.display =
                "none"; // Cambiar la opacidad del botón "Siguiente" a 0
        }
    }
