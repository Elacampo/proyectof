...
$columns = ['activo','email', 'nombre', 'id', 'id_rol', 'apellido'];
$table = "usuarios";
...
if ($num_rows > 0) {
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        $html .= '<td>
                        <div class="iconos">
                            <a href="../../pages/admin/editar_usuario.php?id='.$row['id'].'  " class="editar-icon" title="Editar"><i class="bx bxs-edit bx-sm"></i></a>'
