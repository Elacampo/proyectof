...
<body>
    ...
    <section class="home">
        ...
        <div class="inicio">
            ...
            <div class="text">
                <div class="info">
                    <h5>Espacio</h1>
                        <h6>Administrar Espacio</h2>
                </div>

                <div class="agregar">
                    <a href="agregar_espacio.php">Añadir Espacio</a>
                </div>
            </div>
    ...
    function alertaEliminar(event) {
        ...
        Swal.fire({
            title: "¿Estás seguro que deseas eliminar este espacio?",
            text: "Una vez eliminado, el espacio ya no estará disponible para su uso en el sistema.",
            icon: "warning",
