...
<body>
    ...
    <section class="home">
        ...
        <div class="inicio">
            ...
            <div class="text">
                <div class="info">
                    <h5>Categoria</h1>
                        <h6>Administrar Categorias</h2>
                </div>

                <div class="agregar">
                    <a href="agregar_categoria.php">Añadir categoria</a>
                </div>
            </div>
    ...
    function alertaEliminar(event) {
        ...
        Swal.fire({
            title: "¿Estás seguro que deseas desactivar esta categoría?",
            text: "Una vez desactivada, la categoría ya no estará disponible para su uso ni visualización.",
            icon: "warning",
            showCancelButton: true,
            cancelButtonText: "Cancelar",
            confirmButtonColor: "#45b867",
            cancelButtonColor: "#d33",
            confirmButtonText: "Sí, desactivar categoría."
        }).then((result) => {
    ...
    function alertaRestablecer(event) {
        ...
        Swal.fire({
            title: "¿Estás seguro que deseas activar esta categoría?",
            text: "Una vez activada, la categoría estará disponible para su uso y visualización.",
            icon: "warning",
            showCancelButton: true,
            cancelButtonText: "Cancelar",
            confirmButtonColor: "#45b867",
            cancelButtonColor: "#d33",
            confirmButtonText: "Sí, activar categoría."
        }).then((result) => {
            if (result.isConfirmed) {
                Swal.fire({
