    ...
    <body>
        ...
        <section class="home">
            ...
            <div class="inicio">
                ...
                <div class="text">
                    <div class="info">
                        <h5>Proveedores</h1>
                            <h6>Administrar Proveedores</h2>
                    </div>

                    <div class="agregar">
                        <a href="agregar_proveedor.php">Añadir proveedor</a>
                    </div>
                </div>
        ...
        function getData(pagina) {
            ...
            let url = "../../php/loadProveedores.php";
        ...
        function alertaEliminar(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        title: "¡Eliminado!",
                        text: "El usuario ha sido eliminado de forma exitosa.",
                        icon: "success",
