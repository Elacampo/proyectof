                        ...
                        <div class="info-izquierda">
                            ...
                            <div class="info_card">
                                ...
                                <div class="descripcion">
                                    <h2>Descripción<h5>(Utiliza un guion seguido de un espacio antes de cada palabra
                                            para los subtítulos.)</h5>
                                    </h2>
                        ...
                        <div class="info-derecha">
                            ...
                            <div class="fila filaEditar">
                                ...
                                <div class="precio">
                                    ...
                                    <input type="text" name='precio_producto'
                                        value="<?php echo $row['precio_producto']?>">
                                </div>
                            </div>
                            ...
                            <div class="qr_code">
                                ...
                                <figure class="codigo_qr">
                                    ...
                                    <img src="../../img/codigos_qr/<?php echo $row['qr_imagen']?>"
...
const expresiones = {
    ...
    stockNum_verificar: /^\d+$/,
    valor_producto_verificar: /^\d{1,3}(?:\.\d{3})*(,\d{1,2})?$/
};
