...
if($_SESSION['rol'] == 2){
    header("location: ../cliente/mi-cuenta.php");
}
                    ...
                    <li class="text-left mb-10">
                        <div class="flex flex-row items-start mb-5">
                            ...
                            <div class="bg-gray-100 p-5 px-10 w-full flex items-center">
                                <h4 class="text-md leading-6 font-medium text-gray-900">¿Qué debo hacer una vez que
                                    tenga la factura generada en línea?</h4>
                            </div>
                        </div>

                        <div class="flex flex-row items-start">
                            <div class="bg-blue-100 p-5 px-10 w-full flex items-center">
                                <p class="text-gray-700 text-sm"> Una vez que hayas generado la factura en línea, por
                                    favor imprímela o guárdala en tu dispositivo móvil y llévala a nuestro local físico.
                                    Nuestro personal estará encantado de ayudarte a completar tu compra y procesar el
                                    pago.
                                </p>
                            </div>
                            <div
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"></path>
                    ...
                    <li class="text-left mb-10">
                        <div class="flex flex-row items-start mb-5">
                            ...
                            <div class="bg-gray-100 p-5 px-10 w-full flex items-center">
                                <h4 class="text-md leading-6 font-medium text-gray-900">¿Qué tipo de información puedo
                                    obtener al escanear el código QR de un producto?</h4>
                            </div>
                        </div>

                        <div class="flex flex-row items-start">
                            <div class="bg-blue-100 p-5 px-10 w-full flex items-center">
                                <p class="text-gray-700 text-sm">Al escanear el código QR de un producto, tendrás acceso
                                    a información detallada sobre el mismo, que puede incluir instrucciones de uso,
                                    dosis recomendada, posibles efectos secundarios, precauciones y advertencias
                                    importantes. Esta información está diseñada para ayudarte a comprender mejor el
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"></path>
                    ...
                    <li class="text-left mb-10">
                        <div class="flex flex-row items-start mb-5">
                            ...
                            <div class="bg-gray-100 p-5 px-10 w-full flex items-center">
                                <h4 class="text-md leading-6 font-medium text-gray-900">¿Qué debo hacer si encuentro un
                                    error en mi factura generada en línea?</h4>
                            </div>
                        </div>

                        <div class="flex flex-row items-start">
                            <div class="bg-blue-100 p-5 px-10 w-full flex items-center">
                                <p class="text-gray-700 text-sm">Si experimentas algún problema con tu factura generada
                                    en línea, como errores en los detalles del producto, discrepancias en el precio
                                    total o cualquier otra preocupación, te recomendamos que nos contactes de inmediato.
                                    Puedes comunicarte con nosotros por correo electrónico, teléfono o a través de
                                    nuestro formulario de contacto en línea.
                                </p>
                            </div>
                            <div
                                class="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-blue-500 text-white border-4 border-white text-xl font-semibold">
